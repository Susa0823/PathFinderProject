...
class UpdateProfile(forms.ModelForm):
    profile_picture = forms.ImageField(
        widget=forms.FileInput(attrs={"class": "form-control-file"}), required=True
    )
...
class NotesForm(ModelForm):
    ...
    text = forms.CharField(
        ...
        widget=forms.Textarea(
            attrs={"class": "form-control", "placeholder": "Enter Notes", "rows": "8"}
        ),
    )
...
class ContactForm(forms.Form):
    ...
    message = forms.CharField(
        label="Message",
        widget=forms.Textarea(
            attrs={"class": "form-control mb-2", "rows": 5, "placeholder": "Message"}
        ),
    )
